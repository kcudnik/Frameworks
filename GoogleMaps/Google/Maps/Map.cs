namespace Bridge.Google.Maps
{
    ...
    public class Map : MVCObject
    {
        ...
        /// </summary>
        /// <param name="mapDiv">Element for map.</param>
        ...
        /// The bounds.
        /// </param>
        public extern void FitBounds(Any<LatLngBounds, LatLngBoundsLiteral> bounds);
        ...
        /// The lat lng bounds.
        /// </param>
        public extern void PanToBounds(Any<LatLngBounds, LatLngBoundsLiteral> latLngBounds);

namespace Bridge.Google.Maps.Geometry
{
    ...
    public static class Spherical
    {
        ...
        /// The <see cref="double"/>.
        /// </returns>
        public static extern double ComputeArea(Any<LatLng[], MVCArray<LatLng>> path, double radius = 0);
        ...
        /// The <see cref="double"/>.
        /// </returns>
        public static extern double ComputeLength(Any<LatLng[], MVCArray<LatLng>> array, double radius = 0);
        ...
        /// The <see cref="double"/>.
        /// </returns>
        public static extern double ComputeSignedArea(Any<LatLng[], MVCArray<LatLng>> loop, double radius = 0);
